...
class _ProductDetailScreenState extends State<ProductDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final vendor = product != null ? context.read<VendorProvider>().getById(product.vendorId) : null;
    ...
    final productReviews = mockReviewsData.where((r) => r.vendorId == product.vendorId).toList();
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Price
                      Text(formatPKR(product.pricePerUnit), style: AppTypography.price),
                      if (product.bulkPrice != null)
                        Text(
                          'Bulk: ${formatPKR(product.bulkPrice!)} (${product.bulkMinQty}+ units)',
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          TextButton(
                            onPressed: () => context.push('/product/${product.vendorId}/reviews'),
