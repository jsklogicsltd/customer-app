...
class _CustomRequestStep1ScreenState extends State<CustomRequestStep1Screen> {
  ...
  List<Map<String, dynamic>> _getSubCategories(List<Map<String, dynamic>> hierarchy) {
    if (_selectedCategory == null) return [];
    final cat = hierarchy.firstWhere(
  ...
  List<String> _getProductTypes(List<Map<String, dynamic>> hierarchy) {
    if (_selectedSubCategory == null) return [];
    final subs = _getSubCategories(hierarchy);
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (provider.step1SubCategory.isNotEmpty) {
        setState(() => _selectedSubCategory = provider.step1SubCategory);
      }
